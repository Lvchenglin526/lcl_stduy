...
class LanguageModel(nn.Module):
    def __init__(self, vocab):
        ...
        model_path = r"D:\ANACONDA\envs\py312\Lib\site-packages\modelscope\hub\models\google-bert\bert-base-chinese"
...
def train(corpus_path, save_weight=False):
    ...
    tokenizer = (BertTokenizer.from_pretrained
                 (r"D:\ANACONDA\envs\py312\Lib\site-packages\modelscope\hub\models\google-bert\bert-base-chinese", do_lower_case=True))
    ...
    if save_weight:
        model_path = os.path.join(r"D:\AI  Learning\课程内容\ELEVEN_Week\EVELENWEEK\sft\models",
                                  "DIY_nnlm_bert.pth")
